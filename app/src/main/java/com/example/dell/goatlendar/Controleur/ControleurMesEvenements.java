...
public class ControleurMesEvenements extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater , ViewGroup container , Bundle savedInstanceState){
        ...
        View view = inflater.inflate(com.example.dell.goatlendar.R.layout.calendar , container , false);
        //recuperation du bouton ajouter un evenement
        FloatingActionButton button = (FloatingActionButton) view.findViewById(com.example.dell.goatlendar.R.id.fab);
        ...
        button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                promptView = layoutInflater.inflate(com.example.dell.goatlendar.R.layout.create_event, null);
                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(getContext());
                alertDialogBuilder.setView(promptView);

                Button valider_creation = (Button) promptView.findViewById(com.example.dell.goatlendar.R.id.button_ok);
                Button annuler_creation = (Button) promptView.findViewById(com.example.dell.goatlendar.R.id.button_cancel);
                ...
                image_chooser = (Button)promptView.findViewById(com.example.dell.goatlendar.R.id.button_choose_image);
                //rrecuperation du bouton retirer une image de la page cree evenemenr
                image_remove = (Button)promptView.findViewById(com.example.dell.goatlendar.R.id.button_remove_image);
                ...
                image_remove.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        ImageView imageView = (ImageView) promptView.findViewById(com.example.dell.goatlendar.R.id.selectedImage);
                ...
                final AutoCompleteTextView textView = (AutoCompleteTextView) promptView.findViewById(com.example.dell.goatlendar.R.id.autoCompleteTextView1);
                textView.setAdapter(adapter);

                //initialiser la liste des invites
                listeInvitees  = (ListView) promptView.findViewById(com.example.dell.goatlendar.R.id.liste_affichage_amis);
        ...
        //*************************
        listView = (ListView)view.findViewById(com.example.dell.goatlendar.R.id.listeEvent);
        //*************************

        CalendarView calendarView = (CalendarView)view.findViewById(com.example.dell.goatlendar.R.id.calendar);
        ...
        NavigationView navigationView = getActivity().findViewById(com.example.dell.goatlendar.R.id.barre_de_nav);
        textViewNomUser = navigationView.getHeaderView(0).findViewById(com.example.dell.goatlendar.R.id.textNom);
        textViewEmail = navigationView.getHeaderView(0).findViewById(com.example.dell.goatlendar.R.id.textEmail);
    ...
    private void recupererTouslesEvenements(String d){
        ...
        //progressbar
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Constants.URL_GetMesEvenements, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                //Récupération de la réponse JSON
                try {
